...
.PHONY: help install dev install-hooks up down logs ps restart \
        ...
        migrate alembic-rev \
        smoke-llm demo demo-iter-0 demo-iter-1 demo-iter-2 demo-iter-3 demo-iter-4 demo-iter-5 demo-iter-6 demo-iter-7 \
        clean
...
demo-iter-7: ## Run iter-7 e2e (Architect 600s + LLMTimeoutError stdout + transitive cascade drops)
