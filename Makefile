...
demo: demo-iter-24 ## Alias for the current iteration's demo

demo-iter-24: ## Run iter-24 e2e (TL summary-prefix routing + Backend missing-dir handling + log preservation)
	bash scripts/demo_iter_24.sh

demo-iter-23: ## Run iter-23 e2e (QA Python safety net + 45-min poll window)
	bash scripts/demo_iter_23.sh
